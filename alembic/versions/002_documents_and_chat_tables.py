...
def upgrade() -> None:
    ...
    # Migration 001 uses Base.metadata.create_all() which creates every table.
    # Guard each statement so this migration is safe to apply on databases that
    # were bootstrapped by 001 as well as truly empty ones.
